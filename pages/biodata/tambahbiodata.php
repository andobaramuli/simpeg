        ...
        <div class="page-header float-right">
          <div class="page-title">
            <ol class="breadcrumb text-right">
              ...
              <li><a href="#">Biodata Pegawai</a></li>
              <li class="active">Tambah Biodata Pegawai</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <strong>Tambah Biodata Pegawai</strong>
                <a href="tambahbiodata.php" type="button" class="btn btn-primary btn-sm pull-right"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
              </div>
