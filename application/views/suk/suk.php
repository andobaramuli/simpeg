            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Tabel Sub Unit Kerja</strong>
                        <a href="<?=site_url()?>suk/addsuk" type="button" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i>&nbsp; Tambah Sub Unit Kerja</a>
                    </div>
                    <div class="card-body">
              <table id="bootstrap-data-table" class="table table-striped table-bordered">
                ...
                <tbody>
                  <?php foreach ($suk as $key => $value) {
                  ?>
                  <tr>
                    <td><?=$key+1?></td>
                    <td><?=$value->subunitkerja?></td>
                    <td></td>
                  </tr>
                  <?php
                  }?>
