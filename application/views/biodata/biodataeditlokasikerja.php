  ...
  <div class="content mt-3">
    <div class="animated fadeIn">
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="card">
            <form action="<?=site_url()?>biodata/updatelokasikerja/<?=$pegawai[0]->kodetmtlokasikerja?>" method="post">
              <input type="hidden" name="kodepegawai" value="<?=$pegawai[0]->kode?>" />
              <div class="card-header">
                <strong class="card-title">Lokasi Kerja</strong>
                <button type="submit" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i>&nbsp; Simpan Lokasi Kerja</button>
              </div>
              <div class="card-body">
                <div class="row form-group">
                  ...
                  <div class="col-lg-9">
                    <select id="unitkerja" name="unitkerja" data-placeholder="Pilih Unit Kerja" class="form-control" tabindex="1">
                      ...
                      foreach ($uk as $k1 => $v1) {
                        ?>
                        <option value="<?=$v1->kode?>" <?=$pegawai[0]->kodeunitkerja == $v1->kode ? 'selected' : null ?>><?=$v1->unitkerja?></option>
                        <?php
                      }
                      ?>
                    </select>
                ...
                <div class="row form-group">
                  ...
                  <div class="col-lg-9">
                    <select id="subunitkerja" name="subunitkerja" data-placeholder="Pilih Sub Unit Kerja" class="form-control" tabindex="1">
                      <option value="0">-- pilih sub unit kerja --</option>
                      <?php
                      foreach ($suk as $k2 => $v2) {
                        ?>
                        <option value="<?=$v2->kode?>" <?=$pegawai[0]->kodesubunitkerja == $v2->kode ? 'selected' : null ?>><?=$v2->subunitkerja?></option>
                        <?php
                      }
                      ?>
                    </select>
                ...
                <div class="row form-group">
                  ...
                  <div class="col-lg-9">
                    <select id="subsubunitkerja" name="subsubunitkerja" data-placeholder="Pilih Sub Subunit Kerja" class="form-control" tabindex="1">
                      ...
                      <?php
                      foreach ($ssuk as $k3 => $v3) {
                        ?>
                        <option value="<?=$v3->kode?>" <?=$pegawai[0]->kodesubsubunitkerja == $v3->kode ? 'selected' : null ?>><?=$v3->subsubunitkerja?></option>
                        <?php
                      }
                      ?>
                    </select>
                ...
                <div class="row form-group">
                  ...
                  <div class="col-lg-9">
                    <input type="text" id="" name="tmtlokasikerja" value="<?=!empty($pegawai[0]->tmtlokasikerja) ? $pegawai[0]->tmtlokasikerja : null ?>" class="form-control date" >
                  </div>
                </div>
              </div>
            </form>
