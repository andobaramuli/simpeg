      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <form action="<?=site_url()?>biodata/updatepangkat/<?=$pegawai[0]->kodetmtpangkat?>" method="post">
              <input type="hidden" name="kodepegawai" value="<?=$pegawai[0]->kode?>" />
              <div class="card-header">
                <strong class="card-title">Pangkat / Golongan</strong>
                <button href="" type="submit" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i>&nbsp; Simpan Pangkat / Golongan</button>
              </div>
              <div class="card-body">
                <div class="row form-group">
                  <div class="col-lg-3">
                  ...
                  <div class="col-lg-9">
                    <select name="pangkat" class=" form-control " tabindex="1">
                      ...
                      foreach ($pangkat as $key => $value) {
                        ?>
                        <option value="<?=$value->kode?>" <?=$value->kode == $pegawai[0]->kodepangkat ? 'selected' : null ?>><?=$value->namapangkat?></option>
                        <?php
                      }
                      ?>
                    </select>
                ...
                <div class="row form-group">
                  ...
                  <div class="col-lg-9">
                    <input type="text" id="" name="tmtpangkat" value="<?=!empty($pegawai[0]->tmtpangkat) ? $pegawai[0]->tmtpangkat : null ?>" class="form-control date">
                  </div>
                </div>
              </div>
            </form>
