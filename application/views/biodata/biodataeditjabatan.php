      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <form action="<?=site_url()?>biodata/updatejabatan/<?=$pegawai[0]->kodetmtjabatan?>" method="post">
              ...
              <div class="card-header">
                ...
                <button type="submit" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i>&nbsp; Simpan Jabatan</a>
              </div>
              <div class="card-body">
                <div class="row form-group">
                  <div class="col-lg-3">
                  ...
                  <div class="col-lg-9">
                    <input type="text" id="" name="jabatan" value="<?=!empty($pegawai[0]->jabatan) ? $pegawai[0]->jabatan : null ?>" placeholder="" class="form-control" >
                  </div>
                </div>
                <div class="row form-group">
                  <div class="col-lg-3">
                  ...
                  <div class="col-lg-9">
                    <input type="text" id="" name="tugasunitkerja" value="<?=!empty($pegawai[0]->tugasjabatan) ? $pegawai[0]->tugasjabatan : null ?>" placeholder="" class="form-control" >
                  </div>
                </div>
                <div class="row form-group">
                  <div class="col-lg-3">
                  ...
                  <div class="col-lg-9">
                    <input type="text" id="" name="tmtjabatan" value="<?=!empty($pegawai[0]->tmtjabatan) ? $pegawai[0]->tmtjabatan : null ?>" placeholder="" class="form-control date" >
                  </div>
                </div>
              </div>
            </form>
